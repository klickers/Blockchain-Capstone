...
contract Ownable
{
    ...
    modifier onlyOwner()
    {
        require(_owner == msg.sender, "Sender must be the owner");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != _tokenOwner[tokenId], "Token addresses cannot be the same");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == _tokenOwner[tokenId] || true == isApprovedForAll(_tokenOwner[tokenId], msg.sender), "Caller is not approved");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == from, "From sender does not own this token");
...
contract GliceToken is ERC721Metadata("glice", "GLT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/")
{
