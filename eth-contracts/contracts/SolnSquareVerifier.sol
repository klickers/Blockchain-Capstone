...
contract SolnSquareVerifier is GliceToken {
    ...
    SquareVerifier public SVContract;
    constructor(address addr) public {
        SVContract = SquareVerifier(addr);
    }
        ...
        returns(bool)
    {
        ...
        require(solutions[solutionHash].addr == address(0x0), "Invalid!  Solution already exists");
